...
import { ActivePostState } from '../App';
import { useSwipe } from './useSwipe';

interface MediaPlayerProps {
  data: NonNullable<ActivePostState>;
  onClose: () => void;
  onMinimize: () => void;
  onRestore: () => void;
  onNext: () => void;
...
const MinimizedPlayer: React.FC<MediaPlayerProps> = ({ data, onClose, onMinimize, onRestore, onNext, onPrev, hasNext, hasPrev }) => {
  ...
  const swipeHandlers = useSwipe({
      ...
      onSwipedUp: onClose,
      onSwipedDown: isMedia ? onMinimize : onClose,
  });
  ...
  const handleBackdropClick = isModal ? (isMedia ? onMinimize : onClose) : onRestore;
